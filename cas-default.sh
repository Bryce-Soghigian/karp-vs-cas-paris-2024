...
az aks create --resource-group $RG_NAME --name $CLUSTER_NAME --node-count 1 --enable-addons monitoring --generate-ssh-keys --sku Standard --enable-cluster-autoscaler --min-count 1 --max-count 10 --node-vm-size Standard_DS2_v2 --enable-cost-analysis
